...
## Download files
- [💻 basics.ipynb](https://colab.research.google.com/github/kirenz/lab-chat-system/blob/main/code/basics.ipynb)
:::
...
::: {.callout-tip appearance="simple" icon=false}
## Download files
- [💻 classification.ipynb](https://colab.research.google.com/github/kirenz/lab-chat-system/blob/main/code/classification.ipynb)
:::
...
::: {.callout-tip appearance="simple" icon=false}
## Download files
- [💻 moderation.ipynb](https://colab.research.google.com/github/kirenz/lab-chat-system/blob/main/code/moderation.ipynb)
:::
...
::: {.callout-tip appearance="simple" icon=false}
## Download files
- [💻 reasoning.ipynb](https://colab.research.google.com/github/kirenz/lab-chat-system/blob/main/code/reasoning.ipynb)
:::
...
::: {.callout-tip appearance="simple" icon=false}
## Download files
- [💻 chaining.ipynb](https://colab.research.google.com/github/kirenz/lab-chat-system/blob/main/code/chaining.ipynb)
:::
...
::: {.callout-tip appearance="simple" icon=false}
## Download files
- [💻 outputcheck.ipynb](https://colab.research.google.com/github/kirenz/lab-chat-system/blob/main/code/outputcheck.ipynb)
:::
...
::: {.callout-tip appearance="simple" icon=false}
## Download files
- [💻 system.ipynb](https://colab.research.google.com/github/kirenz/lab-chat-system/blob/main/code/system.ipynb)
...
::: {.callout-tip appearance="simple" icon=false}
## Download files
- [💻 evaluation_2.ipynb](https://colab.research.google.com/github/kirenz/lab-chat-system/blob/main/code/evaluation_2.ipynb)
:::